...
function MatchWtstyle() {
    ...
    return (_jsxs(MainContainer, { children: [_jsx(GlobalStyle, {}), _jsx(BackButton, {}), _jsxs(Title, { children: [_jsx(H1, { children: "\uB2E8\uCCB4\uC804\uC744 \uD568\uAED8 \uD558\uACE0 \uC2F6\uC740" }), _jsx(H1, { children: "\uC791\uAC00\uB2D8\uC758 \uC2A4\uD0C0\uC77C\uC5D0 \uB300\uD574 \uC54C\uB824\uC8FC\uC138\uC694!" }), _jsx(H3, { children: "\uC5EC\uB7EC \uAC1C\uB97C \uACE0\uB97C \uC218 \uC788\uC5B4\uC694!" })] }), _jsx(BtnContainer, { children: styles.map((style, index) => (_jsx(Btns, { children: _jsx(SelectButton, { label: style, width: "auto", onClick: () => handleSelect(index), isSelected: selectedBtn[index] }) }, index))) }), _jsxs("div", { children: [_jsx(ProgressBar, { children: _jsx(Progress, { width: (avaliableItem * 100) / maxItem }) }), _jsxs(NextBtn, { onClick: handleNextClick, children: [_jsx("button", { children: "\uC774\uC81C, \uB354 \uB113\uC740 \uC138\uC0C1\uC73C\uB85C" }), _jsx("img", { src: nextbtn })] })] })] }));
}
