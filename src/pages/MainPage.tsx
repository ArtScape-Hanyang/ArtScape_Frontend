...
const MainPage = () => {
  return (
    <MainContainer>
      ...
      <ProfileContainer>
        <ProfileImgContainer01 />
        <ProfileTextContainer>
          <BodyS400>서울특별시 성동구</BodyS400>
          <BodyM600>이재욱 작가님</BodyM600>
          <BodyR500>#서양화</BodyR500>
        </ProfileTextContainer>
      </ProfileContainer>
      <ProfileContainer>
        <ProfileImgContainer02 />
        <ProfileTextContainer>
          <BodyS400>경기도 안산시</BodyS400>
          <BodyM600>신은서 작가님</BodyM600>
          <BodyR500>#서양화</BodyR500>
        </ProfileTextContainer>
      </ProfileContainer>
      <ProfileContainer>
        <ProfileImgContainer03 />
        <ProfileTextContainer>
          <BodyS400>제주특별자치도 제주시</BodyS400>
          <BodyM600>정재민 작가님</BodyM600>
          <BodyR500>#종교예술</BodyR500>
        </ProfileTextContainer>
      </ProfileContainer>
      <ProfileContainer>
        <ProfileImgContainer03 />
