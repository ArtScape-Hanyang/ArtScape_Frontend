...
const MapChart = ({ selectedPlace }: { selectedPlace: Place }) => {
  return (
    <MainContainer>
      <TitleContainer>
        <H3> {selectedPlace?.content || "선택된 장소가 없습니다."}</H3>
        <svg
